<?php
/**
 * Wird untehalb einer RezeptDetailansicht eingefügt, um die zugehörigen Bewertungen anzuzeigen. 
 */
...
//Initialisierungen 
$rezept_id = intval($_GET['rezept_id']); 
...
<!-- HTML-Teil, um die Bewertugnen anzuzeigen --> 
